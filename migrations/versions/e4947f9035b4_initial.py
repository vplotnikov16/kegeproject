...
Revision ID: e4947f9035b4
Revises: 
Create Date: 2025-12-05 23:20:46.566847
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('variant_id', 'task_id', name=op.f('pk_variant_tasks'))
    )
    ...
    sa.ForeignKeyConstraint(['task_id'], ['tasks.id'], name=op.f('fk_attempt_answers_task_id_tasks'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('attempt_id', 'task_id', name=op.f('pk_attempt_answers'))
    )
